...
const WeatherIcons = [
	{
		code: 1000,
		text: "Sunny",
		value: <WiDaySunny size={150} style={{ color: "white" }} />,
		forecast: <WiDaySunny size={45} style={{ color: "white" }} />
	},
	{
		code: 1003,
		text: "Partly cloudy",
		value: <WiDayCloudy size={150} style={{ color: "white" }} />,
	...
	},
	{
		code: 1009,
		text: "Overcast",
		value: <WiFog size={150} style={{ color: "white" }} />,
	...
	},
	{
		...
		value: <WiRain size={150} style={{ color: "white" }} />,
		forecast: <WiRain size={45} style={{ color: "white" }} />
	},
	{
		code: 1066,
		text: "Patchy snow possible",
		value: <WiSnowWind size={150} style={{ color: "white" }} />,
...

	{
		...
		value: <WiSleet size={150} style={{ color: "white" }} />,
	...
	},
	{
		...
		value: <WiDayThunderstorm size={150} style={{ color: "white" }} />,
	...
	},
	{
		...
		value: <WiDaySnowThunderstorm size={150} style={{ color: "white" }} />,
